class detail_recipe_model {
  String? method;
  bool? status;
  Results? result;

  detail_recipe_model({this.method, this.status, this.result});

  detail_recipe_model.fromJson(Map<String, dynamic> json) {
    method = json['method'];
    status = json['status'];
    result =
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.result != null) {
      data['results'] = this.result!.toJson();
    }
    return data;
  }
}

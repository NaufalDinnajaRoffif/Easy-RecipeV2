...
class MasakanTradisional extends StatefulWidget {
  const MasakanTradisional({Key? key}) : super(key: key);

  @override
  State<MasakanTradisional> createState() => _MasakanTradisionalState();
}

class _MasakanTradisionalState extends State<MasakanTradisional> {
  RecipesModel? recipeModel;
  bool isloaded = false;

  void getAllListCategoryScreen() async {
    final res = await http.get(Uri.parse(
        URL.recipes_URL_MasakanTradisional));

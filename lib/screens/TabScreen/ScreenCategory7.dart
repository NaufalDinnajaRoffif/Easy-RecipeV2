...
class ResepSayuran extends StatefulWidget {
  const ResepSayuran({Key? key}) : super(key: key);

  @override
  State<ResepSayuran> createState() => _ResepSayuranState();
}

class _ResepSayuranState extends State<ResepSayuran> {
  RecipesModel? recipeModel;
  bool isloaded = false;

  void getAllListCategoryScreen() async {
    final res = await http.get(Uri.parse(
        URL.recipes_URL_ResepSayuran));

...
class ResepDaging extends StatefulWidget {
  const ResepDaging({Key? key}) : super(key: key);

  @override
  State<ResepDaging> createState() => _ResepDagingState();
}

class _ResepDagingState extends State<ResepDaging> {
  RecipesModel? recipeModel;
  bool isloaded = false;

  void getAllListCategoryScreen() async {
    final res = await http.get(Uri.parse(
        URL.recipes_URL_ResepDaging));

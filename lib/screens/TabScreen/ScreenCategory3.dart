...
class MenuMakanMalam extends StatefulWidget {
  const MenuMakanMalam({Key? key}) : super(key: key);

  @override
  State<MenuMakanMalam> createState() => _MenuMakanMalamState();
}

class _MenuMakanMalamState extends State<MenuMakanMalam> {
  ...
  void getAllListCategoryScreen() async {
    final res = await http.get(Uri.parse(URL.Base_URL +
        ...
        URL.recipes_URL_MenuMakanMalam));

...
class MasakanHariRaya extends StatefulWidget {
  const MasakanHariRaya({Key? key}) : super(key: key);

  @override
  State<MasakanHariRaya> createState() => _MasakanHariRayaState();
}

class _MasakanHariRayaState extends State<MasakanHariRaya> {
  ...
  void getAllListCategoryScreen() async {
    final res = await http.get(Uri.parse(URL.Base_URL +
        ...
        URL.recipes_URL_MasakanHariRaya));

...
import 'package:easy_v3/widgets/shimmer_list.dart';import 'dart:convert';
import 'package:easy_v3/utils/config.dart';
import 'package:easy_v3/utils/url.dart';
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Text("Diciptakan Oleh: "+
                                    detailrecipe!.result!.author!.user.toString(),
                                  style: GoogleFonts.poppins(
                                      fontSize: 14, color: Colors.black),

                                ),
                                Text("Recipe dibuat pada: "+
                                    detailrecipe!.result!.author!.datePublished.toString(),
                                  style: GoogleFonts.poppins(
                                      fontSize: 14, color: Colors.black),

                                ),
                                Text("tingkat kesulitan: "+
                                    detailrecipe!.result!.difficulty.toString(),
                                  style: GoogleFonts.poppins(
                                      fontSize: 14, color: Colors.black),

                                ),
                                Text("Penyajian Untuk: "+
                                    detailrecipe!.result!.servings.toString(),
                                  style: GoogleFonts.poppins(
                                      fontSize: 14, color: Colors.black),
